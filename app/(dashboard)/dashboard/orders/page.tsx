    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-[#1A1C1C]">Orderhantering</h1>
                    <p className="text-[#78716C] mt-2 max-w-2xl">Övervaka all transaktionsaktivitet inom organisationen med precision och tydlighet.</p>
                </div>
            </div>
