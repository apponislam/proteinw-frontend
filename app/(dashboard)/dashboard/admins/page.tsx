    ...
    return (
        <div className="space-y-6 sm:space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1A1C1C]">Intern styrning</h1>
                    <p className="text-[#78716C] text-xs sm:text-sm mt-1 sm:mt-2 max-w-2xl">Hantera systemadministratörer, deras funktionella gränser och övervaka den operativa prestandan över arkivet.</p>
                </div>
                <button
