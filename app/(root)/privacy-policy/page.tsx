        ...
        <main className="bg-[#F5F5F4] text-[#1C1917] py-20">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="space-y-8">
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">1. Introduction</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">2. Information We Collect</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">3. Use of Your Information</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">4. Data Security</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">5. Third-Party Links</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">6. Your Rights</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">7. Contact Us</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">8. Changes to This Policy</h2>
