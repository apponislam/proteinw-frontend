        ...
        <main className="bg-[#F5F5F4] text-[#1C1917] py-20">
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <div className="space-y-8">
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">1. Agreement to Terms</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">2. Use License</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">3. Disclaimer</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">4. Limitations</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">5. Accuracy of Materials</h2>
                        <p className="text-gray-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">6. Links</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">7. Modifications</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">8. User Responsibilities</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">9. Payment Terms</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold mb-4 text-[#EFAC02]">10. Contact Information</h2>
