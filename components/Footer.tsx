...
const Footer = () => {
    ...
    const accountHref = mounted && user ? "/dashboard" : "/auth/login";
            ...
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="flex flex-col justify-between">
                        <div>
                            <h2 className="text-2xl sm:text-3xl font-bold mb-3 tracking-tight">Kungsbjörnen</h2>
                            <p className="text-gray-600 leading-relaxed text-sm max-w-sm">En enklare väg till en lyckad insamling. Vi hjälper skolor och föreningar att sälja smartare och nå sina mål tillsammans.</p>
                        </div>

                        {/* Social Icons */}
                        <div className="flex items-center gap-3 mt-6">
                            <Link href="/" aria-label="Facebook" className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-xs text-gray-700 hover:bg-[#EFAC02] hover:text-white transition-all duration-300">
                                <FacebookIcon size={18} />
                            </Link>

                            <Link href="/" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-xs text-gray-700 hover:bg-[#EFAC02] hover:text-white transition-all duration-300">
                                <InstagramIcon size={18} />
                            </Link>
                        </div>
                    </div>
                    ...
                    {/* Hitta vidare */}
                    <div>
                        <h3 className="text-base font-bold mb-4 text-[#1C1917]">Hitta vidare</h3>
                        <ul className="space-y-2.5 text-sm text-gray-600">
                            <li>
                                <Link href="/sell-with-us" className="hover:text-[#EFAC02] transition-colors">
                                    Sälj med oss
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href={accountHref} className="hover:text-[#EFAC02] transition-colors">
                                    Mina sidor
                                </Link>
                            </li>
                            <li>
                    ...
                    {/* Vi finns här */}
                    <div>
                        <h3 className="text-base font-bold mb-4 text-[#1C1917]">Vi finns här</h3>
                        <ul className="space-y-2.5 text-sm text-gray-600">
                            <li>
                                <Link href="/customer-service" className="hover:text-[#EFAC02] transition-colors">
                                    Kundservice
                                </Link>
                            </li>
                            <li>
