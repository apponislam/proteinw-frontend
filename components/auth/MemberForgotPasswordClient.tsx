                ...
                <div className="w-full max-w-md">
                    <div className="bg-white border border-gray-100 shadow-[0px_4px_25px_rgba(0,0,0,0.05)] rounded-2xl p-8 sm:p-10">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl text-gray-900 font-bold">Forgot Password</h2>
                            <p className="text-xs text-gray-500 mt-1">Enter your email to receive a 6-digit verification code.</p>
                        </div>
