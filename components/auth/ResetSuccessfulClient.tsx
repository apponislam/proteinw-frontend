                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white border-dashed rounded-lg p-4 sm:p-8">
                        ...
                        <div className="text-center mb-6 sm:mb-8">
                            ...
                            <h2 className="text-xl sm:text-2xl text-gray-900 font-bold">Lösenordet har återställts</h2>
                        </div>

                        {/* Success Message */}
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-8">
                            <p className="text-gray-700 text-center">Ditt lösenord har uppdaterats. Du kan nu logga in med dina nya inloggningsuppgifter.</p>
                        </div>
