...
import { useGetSuperAdminGroupsDashboardCardsQuery } from "@/redux/features/dashboard/dashboardApi";

const GroupCards = () => {
    const { data: response, isLoading } = useGetSuperAdminGroupsDashboardCardsQuery();
