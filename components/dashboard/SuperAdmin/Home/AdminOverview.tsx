    ...
    return (
        <div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 md:row-span-2 bg-white p-6 rounded-lg shadow-[0px_0px_14px_0px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0px_0px_20px_0px_rgba(0,0,0,0.12)] flex flex-col justify-between relative overflow-hidden cursor-pointer">
                ...
                {/* Box 2 - Total Sellers */}
                <div className="bg-white p-6 rounded-lg shadow-[0px_0px_14px_0px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0px_0px_20px_0px_rgba(0,0,0,0.12)] hover:translate-y-0.5 hover:bg-[#FFDEA8] relative overflow-hidden group cursor-pointer">
