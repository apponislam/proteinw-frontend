...
const GroupCard: React.FC<GroupCardProps> = ({ className, name, campaignName, activeSellers, totalSales, nextTierProfit, untilBonus }) => {
    return (
