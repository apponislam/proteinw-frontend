        ...
        <>
            <div className="bg-white p-4 sm:p-6 rounded-2xl border border-[#E7E5E4] w-full max-w-xl shadow-sm">
                <div className="border-b border-[#F5F5F4] pb-4 mb-6">
                    <h3 className="text-base sm:text-lg font-bold text-[#1A1C1C]">Starta insamlingsförsäljning</h3>
                    <p className="text-xs text-[#78716C]">Definiera försäljningsparametrar för att börja ta emot försäljning.</p>
                </div>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-[#1A1C1C]">Försäljningsnamn</label>
                    ...
                    <div className="pt-2 space-y-3">
                        <label className="flex items-start sm:items-center gap-3 cursor-pointer select-none">
                            ...
                            <span className="text-xs text-gray-700 font-medium">Lägg automatiskt till alla nuvarande gruppmedlemmar/säljare i denna försäljning</span>
                        </label>
                        ...
                        {!addAllGroupSellersValue && (
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3 pl-0 sm:pl-8">
                                ...
                                >
                                    <Users size={14} />
                                    <span>Välj säljare / Hantera säljare</span>
                                </button>
