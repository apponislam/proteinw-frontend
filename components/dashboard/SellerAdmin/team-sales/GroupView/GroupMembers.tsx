        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl shadow-[0px_0px_20px_0px_rgba(0,0,0,0.04)] border border-[#E7E5E4]">
            <div className="border-b border-[#F5F5F4] pb-4 sm:pb-6 mb-4 sm:mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-lg sm:text-xl font-bold text-[#1A1C1C]">Gruppmedlemmar</h3>
                        <p className="text-xs sm:text-sm text-[#78716C]">Medlemmar som aktivt deltar i denna grupp.</p>
                    </div>
                </div>
            </div>
            ...
            {isLoading ? (
                ...
                <div className="text-center py-8 text-[#78716C] text-sm">Inga aktiva teammedlemmar ännu. Skicka inbjudningar för att bjuda in säljare till ditt team.</div>
            ) : (
                <>
                        ...
                        <table className="w-full text-left border-collapse min-w-135">
                            <thead>
                                <tr className="border-b border-[#F5F5F4] text-xs font-semibold text-[#78716C] uppercase tracking-wider">
                                    <th className="py-3 px-3 sm:px-4">Medlem</th>
                                    <th className="py-3 px-3 sm:px-4">E-post</th>
                                    <th className="py-3 px-3 sm:px-4">Telefon</th>
                                    <th className="py-3 px-3 sm:px-4">Roll</th>
                    ...
                    <div className="mt-4 sm:mt-6">
                        <Pagination meta={meta} onPageChange={setPage} itemName="MEDLEMMAR" />
                    </div>
                </>
            )}
        </div>
