    ...
    return (
        <div className="py-10 sm:py-14 max-w-3xl space-y-6 text-left">
            ...
            <div className="space-y-4 text-base sm:text-lg text-[#514532] leading-relaxed">
                ...
                <p>Vi kommer nu att granska din ansökan och godkänna ditt konto inom 48 timmar. När ditt konto är godkänt kan du skapa din grupp och därefter starta er försäljning.</p>
