    ...
    if (isLoading) {
        return (
            <div className="text-center py-12">
                ...
                <p className="text-[#78716C] text-sm">Laddar gruppinformation...</p>
            </div>
        );
    }

    if (!groups || groups.length === 0) {
        return <div className="mt-8 bg-white p-8 rounded-lg shadow-[0px_0px_14px_0px_rgba(0,0,0,0.08)] text-center text-[#78716C]">Du är för närvarande inte tilldelad någon försäljningsgrupp.</div>;
    }
