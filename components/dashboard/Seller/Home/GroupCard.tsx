        ...
        <div className="bg-white p-6 rounded-lg shadow-[0px_0px_14px_0px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0px_0px_20px_0px_rgba(0,0,0,0.12)] hover:translate-y-0.5 hover:bg-[#FFDEA8] relative overflow-hidden group flex flex-col justify-between">
            <div className="relative z-10">
                ...
                <div className="mb-3 flex items-center justify-between">
                    <div className="text-[#78716C] text-xs group-hover:text-[#271900] transition-colors duration-300">Aktiva säljare</div>
                    <div className="text-[#D97706] font-bold text-base">{activeSellersCount}</div>
                </div>

                <div className="mb-3 flex items-start justify-between">
                    <div className="text-[#78716C] text-xs group-hover:text-[#271900] transition-colors duration-300">Försäljningar</div>
                    <div className="text-right">
                        <div className="text-[#D97706] font-bold text-base">{totalActiveCampaigns} aktiva</div>
                        <div className="text-[#1A1C1C] font-bold text-base group-hover:text-[#271900] transition-colors duration-300">{totalCampaigns} totalt</div>
                    </div>
                </div>
                ...
                {nextTierProfitText && (
                    <div className="mb-4 flex items-center justify-between">
                        <div className="text-[#78716C] text-xs group-hover:text-[#271900] transition-colors duration-300">NÄSTA VINSTNIVÅ</div>
