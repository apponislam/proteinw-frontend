        ...
        <div>
            <div className="flex items-start justify-between gap-8">
                ...
                <div className="shrink-0">
                    <button onClick={copyToClipboard} className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#E7E5E4] text-[#D97706] text-lg font-medium hover:bg-[#F5F5F4] transition-colors">
