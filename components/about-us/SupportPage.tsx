                                ...
                                render={({ field }) => (
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-[#F8F8F8] rounded-xl px-6 h-12 text-sm text-[#514532] outline-none focus:ring-2 focus:ring-[#EFAC02] placeholder:text-[#514532]/60 ${errors.name ? "ring-2 ring-red-500" : ""}`}
                                            {...field}
                                        />
                                ...
                                render={({ field }) => (
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-[#F8F8F8] rounded-xl px-6 h-12 text-sm text-[#514532] outline-none focus:ring-2 focus:ring-[#EFAC02] placeholder:text-[#514532]/60 ${errors.email ? "ring-2 ring-red-500" : ""}`}
                                            {...field}
                                        />
                                ...
                                render={({ field }) => (
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full bg-[#F8F8F8] rounded-xl px-6 h-12 text-sm text-[#514532] outline-none focus:ring-2 focus:ring-[#EFAC02] placeholder:text-[#514532]/60 ${errors.subject ? "ring-2 ring-red-500" : ""}`}
                                            {...field}
                                        />
                            ...
                            render={({ field }) => (
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className={`w-full bg-[#F8F8F8] rounded-xl px-6 py-4 h-52 text-sm text-[#514532] outline-none focus:ring-2 focus:ring-[#EFAC02] resize-none placeholder:text-[#514532]/60 ${errors.message ? "ring-2 ring-red-500" : ""}`}
                                        {...field}
                                    />
